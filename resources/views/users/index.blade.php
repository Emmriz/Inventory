                    ...
                    @forelse($users ?? [] as $user)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if ($user->role === 'admin')
                                    <span
                                        class="px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">ADMIN</span>
                                @else
                                    <span
                                        class="px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">USER</span>
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @else
                                    <span
                                        class="px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">INACTIVE</span>
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
            ...
            <div class="bg-white rounded-lg shadow-lg max-w-md w-full">
                <div class="p-6">
                    ...
                    <form id="editUserForm" method="POST" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="edit_name" class="block text-sm font-medium text-gray-700 mb-1">Full Name
                                *</label>
                        ...
                        <div>
                            <label for="edit_email" class="block text-sm font-medium text-gray-700 mb-1">Email Address
                                *</label>
                        ...
                        <div>
                            <label for="edit_phone" class="block text-sm font-medium text-gray-700 mb-1">Phone
                                Number</label>
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-lg shadow-lg max-w-lg w-full">
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        <p class="text-sm text-gray-600">User: <span id="permissionUserName" class="font-medium"></span>
                        </p>
                        <p class="text-sm text-gray-600">Current Role: <span id="permissionUserRole"
                    ...
                    <form id="permissionsForm" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_create_users" name="permissions[]"
                                        value="create_users"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_delete_users" name="permissions[]"
                                        value="delete_users"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_view_inventory" name="permissions[]"
                                        value="view_inventory"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="perm_view_inventory" class="ml-2 text-sm text-gray-700">View
                                        Inventory</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_create_items" name="permissions[]"
                                        value="create_items"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="perm_create_items" class="ml-2 text-sm text-gray-700">Create Items</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_edit_items" name="permissions[]" value="edit_items"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="perm_edit_items" class="ml-2 text-sm text-gray-700">Edit Items</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_delete_items" name="permissions[]"
                                        value="delete_items"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_view_departments" name="permissions[]"
                                        value="view_departments"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="perm_view_departments" class="ml-2 text-sm text-gray-700">View
                                        Departments</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_manage_departments" name="permissions[]"
                                        value="manage_departments"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="perm_manage_departments" class="ml-2 text-sm text-gray-700">Manage
                                        Departments</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_view_reports" name="permissions[]"
                                        value="view_reports"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="perm_view_reports" class="ml-2 text-sm text-gray-700">View Reports</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" id="perm_export_reports" name="permissions[]"
                                        value="export_reports"
                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <label for="perm_export_reports" class="ml-2 text-sm text-gray-700">Export
                                        Reports</label>
                                </div>
                            </div>
                        </div>
